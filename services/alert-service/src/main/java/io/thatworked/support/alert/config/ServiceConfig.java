 ...
 */
@Configuration
@ConfigurationProperties(prefix = "alert-service.service")
public class ServiceConfig {
    
    private String name = "alert-service";
    private String version = "1.0.0";
    private String description = "Alert management and lifecycle service for NetworkPing Monitor";
    ...
    public static class Api {
        private String basePath = "/api/alerts";
