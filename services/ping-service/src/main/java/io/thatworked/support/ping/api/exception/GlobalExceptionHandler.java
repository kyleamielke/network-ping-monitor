package io.thatworked.support.ping.api.exception;

import io.thatworked.support.ping.config.MessagesConfig;
import io.thatworked.support.ping.config.ServiceConfig;
import io.thatworked.support.common.exception.EntityNotFoundException;
import io.thatworked.support.ping.domain.exception.PingTargetNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleEntityNotFoundException(EntityNotFoundException ex) {
        logger.with("entityType", ex.getEntityType())
        ...
        ErrorResponse error = ErrorResponse.builder()
            ...
            .error(messagesConfig.getApi().getEntityNotFoundTitle())
    ...
    public ResponseEntity<ErrorResponse> handlePingTargetNotFoundException(PingTargetNotFoundException ex) {
        logger.with("message", ex.getMessage())
              .warn("Ping target not found");
        
        ErrorResponse error = ErrorResponse.builder()
            .timestamp(Instant.now())
            .status(HttpStatus.NOT_FOUND.value())
            .error(messagesConfig.getApi().getPingTargetNotFoundTitle())
            .message(ex.getMessage())
            .path(serviceConfig.getApi().getBasePath())
            .build();
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
        logger.with("exceptionType", ex.getClass().getSimpleName())
              .with("method", "handleGenericException")
